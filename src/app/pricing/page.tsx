    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-900 text-white flex flex-col">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto items-stretch">
            {tiers.map((tier, index) => (
              <motion.div
                ...
                className={`relative rounded-3xl p-10 shadow-2xl border-2 flex flex-col ${
                  tier.popular
